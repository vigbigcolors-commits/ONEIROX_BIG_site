/**
 * Merge Wave A + Wave B into pseo/data/dream-lf-matrix.json
...
console.log(
  `wrote ${OUT} · ${payload.count} entries · A=${payload.wave_a} B=${payload.wave_b} indexable=${payload.indexable}`
);
